...
class Analyzer(object):
  def __init__(self,
    ...
    self._create_dirs([undeliverable_path,rawspampath,attachpath,inlinepath])
    ...
    self.dbhandler = DBHandler(attachpath,inlinepath,hpf_host,hpf_port,hpf_ident,hpf_secret)
