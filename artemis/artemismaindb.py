...
import server
import artemisdbconfig
import artemisnotifyerrors
...
def main():
    ...
    try:
        ...
        print e
        if notify is True:
            artemisnotifyerrors.notifydeveloper("[-] Error (Module artemismaindb.py) - executing fetchfromdb %s" % e)
    ...
    try:
        ...
        print e
        if notify is True:
            artemisnotifyerrors.notifydeveloper("[-] Error (Module artemismaindb.py) - executing mainDb %s" % e)
    ...
    try:
        ...
        if spamrecord:
            ...
            try:
                ...
                print e
                if notify is True:
                    artemisnotifyerrors.notifydeveloper("[-] Error (Module artemismaindb.py) - executing insert_spam %s" % e)
            ...
            try:
                ...
                print e
                if notify is True:
                    artemisnotifyerrors.notifydeveloper("[-] Error (Module artemismaindb.py) - executing insert_sdate %s" % e)
            ...
            try:
                ...
                print e
                if notify is True:
                    artemisnotifyerrors.notifydeveloper("[-] Error (Module artemismaindb.py) - executing insert_sdate_spam %s" % e)
            ...
            for ip in ip_list:
                ...
                try:
                    ...
                    print e
                    if notify is True:
                        artemisnotifyerrors.notifydeveloper("[-] Error (Module artemismaindb.py) - executing insert_ip %s" % e)
                ...
                try:
                    ...
                    print e
                    if notify is True:
                        artemisnotifyerrors.notifydeveloper("[-] Error (Module artemismaindb.py) - executing insert_ip_spam %s" % e)    
            ...
            try:
                ...
                print e
                if notify is True:
                    artemisnotifyerrors.notifydeveloper("[-] Error (Module artemismaindb.py) - executing insert_sensor %s" % e)
            ...
            try:
                ...
                print e
                if notify is True:
                    artemisnotifyerrors.notifydeveloper("[-] Error (Module artemismaindb.py) - executing insert_sensor_spam %s" % e)
            ...
            if len(mailFields['links']) != 0:                                     # If links are present - insert into DB
                ...
                while i < len(mailFields['links']):
                    ...
                    try:
                        ...
                        print e
                        if notify is True:
                            artemisnotifyerrors.notifydeveloper("[-] Error (Module artemismaindb.py) - executing insert_link %s" % e)
            ...
            if int(mailFields['relayCounter']) > 0:
                ...
                try:
                    ...
                    print e
                    if notify is True:
                        artemisnotifyerrors.notifydeveloper("[-] Error (Module artemismaindb.py) - executing insert_relay %s" % e)
            ...
            if len(mailFields['attachmentFileMd5']) != 0:                    # If attachment is present - insert into DB
                ...
                while i < len(mailFields['attachmentFileMd5']):
                    ...
                    try:
                        ...
                        print e
                        if notify is True:
                            artemisnotifyerrors.notifydeveloper("[-] Error (Module artemismaindb.py) - executing insert_attachmentFileMd5 %s" % e)
            ...
            if len(mailFields['inlineFileMd5']) != 0:                                # If inline file is present - insert into DB
                ...
                while i < len(mailFields['inlineFileMd5']):
                    ...
                    try:
                        ...
                        print e
                        if notify is True:
                            artemisnotifyerrors.notifydeveloper("[-] Error (Module artemismaindb.py) - executing insert_inline %s" % e)

    except mdb.Error, e:
        print e
        if notify is True:
            artemisnotifyerrors.notifydeveloper("[-] Error (Module artemismaindb.py) - executing insert_spamid %s" % e)
...
def update(tempid, mainid):
    ...
    try:
        ...
        print e
        if notify is True:
            artemisnotifyerrors.notifydeveloper("[-] Error (Module artemismaindb.py) - executing temprecords %s" % e)
    ...
    try:
        ...
        print e
        if notify is True:
            artemisnotifyerrors.notifydeveloper("[-] Error (Module artemismaindb.py) - executing checkDate %s" % e)   
    ...
    if date == 0:
        ...
        try:
            ...
            print e
            if notify is True:
                artemisnotifyerrors.notifydeveloper("[-] Error (Module artemismaindb.py) - insert_sdate %s" % e)
        ...
        try:
            ...
            print e
            if notify is True:
                artemisnotifyerrors.notifydeveloper("[-] Error (Module artemismaindb.py) - insert_sdate_spam %s" % e)
        ...
        try:
            ...
            print e
            if notify is True:
                artemisnotifyerrors.notifydeveloper("[-] Error (Module artemismaindb.py) - update_date %s" % e)
    ...
    try:
        ...
        print e
        if notify is True:
            artemisnotifyerrors.notifydeveloper("[-] Error (Module artemismaindb.py) - update_spam %s" % e)
    ...
    for ip in ip_list:            
        ...
        try:
            ...
            print e
            if notify is True:
                artemisnotifyerrors.notifydeveloper("[-] Error (Module artemismaindb.py) - checkIP %s" % e)
        ...
        if ipStatus == 0:
            ...
            try:
                ...
                print e
                if notify is True:
                    artemisnotifyerrors.notifydeveloper("[-] Error (Module artemismaindb.py) - insert_ip %s" % e)
            ...
            try:
                ...
                print e
                if notify is True:
                    artemisnotifyerrors.notifydeveloper("[-] Error (Module artemismaindb.py) - insert_ip_spam %s" % e)   
    ...
    for sensor in sensor_list:            
        ...
        try:
           ...
           if len(mainDb.fetchall()) >= 1:
            ...
            print e
            if notify is True:
                artemisnotifyerrors.notifydeveloper("[-] Error (Module artemismaindb.py) - checkSensorID %s" % e)
        ...
        if sensorStatus == 1:
            ...
            try:
                ...
                print e
                if notify is True:
                    artemisnotifyerrors.notifydeveloper("[-] Error (Module artemismaindb.py) - insert_id %s" % e)
            ...
            try:
                ...
                print e
                if notify is True:
                    artemisnotifyerrors.notifydeveloper("[-] Error (Module artemismaindb.py) - insert_id_spam %s" % e)
    ...
    for url in mailFields['links']:
        ...
        try:
            ...
            print e
            if notify is True:
                artemisnotifyerrors.notifydeveloper("[-] Error (Module artemismaindb.py) - checkURL %s" % e)
        ...
        if urlstatus == 1:
            ...
            try:
                ...
                print e
                if notify is True:
                    artemisnotifyerrors.notifydeveloper("[-] Error (Module artemismaindb.py) - insert_url %s" % e)
    ...
    if len(mailFields['attachmentFileMd5']) != 0:
        ...
        while i < len(mailFields['attachmentFileMd5']):
            ...
            try:
                ...
                print e
                if notify is True:
                    artemisnotifyerrors.notifydeveloper("[-] Error (Module artemismaindb.py) - checkMd5 %s" % e)
            ...
            if md5Status == 1:
                ...
                try:
                    ...
                    print e
                    if notify is True:
                        artemisnotifyerrors.notifydeveloper("[-] Error (Module artemismaindb.py) - insert_attachment %s" % e)
            i = i + 1
        ...
        while i < len(mailFields['inlineFileMd5']):
            ...
            if md5Status == 1:
                ...
                try:
                    ...
                    print e
                    if notify is True:
                        artemisnotifyerrors.notifydeveloper("[-] Error (Module artemismaindb.py) - insert_inline %s" % e)
            i = i + 1
    ...
    try:
        ...
        print e
        if notify is True:
            artemisnotifyerrors.notifydeveloper("[-] Error (Module artemismaindb.py) - update_users %s" % e)
    ...
    if int(mailFields['relayCounter']) > 0:
        ...
        try:
            ...
            print e
            if notify is True:
                artemisnotifyerrors.notifydeveloper("[-] Error (Module artemismaindb.py) - checkRelayDate %s" % e)
        ...
        if len(mainDb.fetchall()) >= 1:
            ...
            try:
                ...
                print e
                if notify is True:
                    artemisnotifyerrors.notifydeveloper("[-] Error (Module artemismaindb.py) - update_relay %s" % e)
            ...
            try:
                ...
                print e
                if notify is True:
                    artemisnotifyerrors.notifydeveloper("[-] Error (Module artemismaindb.py) - insert_relay %s" % e)

if __name__ == '__main__':
    tempDb = artemisdbconfig.dbconnect()
    mainDb = artemisdbconfig.dbconnectmain()
    notify = server.artemisconf.getboolean('notification', 'enabled')
